create table ex as select * from  s_pur_copy;
-- create table 새로만들 테이블 명 as select * from 대분류코드 있는 본인의 테이블명
select * from ex;
-- A제휴사
-- 편의품 1
drop table m1;
create table m1 as select 고객번호 고객번호,sum(구매금액) 구매금액 , count(영수증번호) 구매횟수 from  ex  where 소분류코드=1 and 구매일자  <20150701 group by 고객번호 order by 고객번호;
select * from m1;
select 고객번호, round(구매금액/구매횟수) from m1;
...
select sum(구매금액) from m1;
-- 선매품 2
create table m2 as select 고객번호 고객번호,sum(구매금액) 구매금액 from  ex  where 소분류코드=2 and 구매일자  <20150701 group by 고객번호 order by 고객번호;
...
select * from m2;
select sum(구매금액) from m2;
drop table m2;
create table m2 as select 고객번호 고객번호,sum(구매금액) 구매금액 , count(영수증번호) 구매횟수 from  ex  where 소분류코드=1 and 구매일자  <20150701 group by 고객번호 order by 고객번호;
select * from m2;
select 고객번호, round(구매금액/구매횟수) from m2;
-- 전문품 3
create table m3 as select 고객번호 고객번호,sum(구매금액) 구매금액 from  ex  where 소분류코드=3 and 구매일자  <20150701 group by 고객번호 order by 고객번호;
...
select * from m3;
select sum(구매금액) from m3;
drop table m3;
create table m3 as select 고객번호 고객번호,sum(구매금액) 구매금액 , count(영수증번호) 구매횟수 from  ex  where 소분류코드=1 and 구매일자  <20150701 group by 고객번호 order by 고객번호;
select * from m3;
select 고객번호, round(구매금액/구매횟수) from m3;
-- 기타 4
create table m4 as select 고객번호 고객번호,sum(구매금액) 구매금액 from  ex  where 소분류코드=4 and 구매일자  <20150701 group by 고객번호 order by 고객번호;
...
select * from m4;
select sum(구매금액) from m4;
drop table m4;
create table m4 as select 고객번호 고객번호,sum(구매금액) 구매금액 , count(영수증번호) 구매횟수 from  ex  where 소분류코드=1 and 구매일자  <20150701 group by 고객번호 order by 고객번호;
select * from m4;
select 고객번호, round(구매금액/구매횟수) from m4;
-- B제휴사
